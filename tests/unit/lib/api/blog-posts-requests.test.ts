...
describe('posts requests (raw)', () => {
  ...
  it('getPosts sends _page/_limit params', async () => {
    ...
    const { getPosts } = await import('@/lib/api/blog/posts/requests');
  ...
  it('getPost fetches a single post by id', async () => {
    ...
    const { getPost } = await import('@/lib/api/blog/posts/requests');
  ...
  it('getPostComments fetches comments for a post', async () => {
    ...
    const { getPostComments } = await import('@/lib/api/blog/posts/requests');
